package com.zkjinshi.superservice.pad.emchat;
        ...
        EMChatManager.getInstance().addConnectionListener(new EMConnectionListener() {
            ...
            public void onDisconnected(int error) {
                if (error == EMError.USER_REMOVED) {
                    ...
                    intent.setAction("com.zkjinshi.superservice.pad.CONNECTION_CONFLICT");
                    BaseContext.getInstance().getContext().sendBroadcast(intent);
                } else {
