 ...
 * 版权所有
 */
public class SwipeRefreshListView extends SwipeMenuListView  implements AbsListView.OnScrollListener {
    ...
    private void initHeaderLayout() {
        ...
        // 设置最后刷新时间
        tvLastUpdateTime.setText(mContext.getString(R.string.latest_update)
                +" "+ TimeUtil.getChatTime(new Date().getTime()));
