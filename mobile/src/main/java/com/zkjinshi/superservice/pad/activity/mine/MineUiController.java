package com.zkjinshi.superservice.pad.activity.mine;
...
import com.zkjinshi.superservice.pad.activity.common.CutActivity;
...
public class MineUiController {
     ...
     */
    public void onActivityResult(int requestCode, int resultCode, Intent data, final SimpleDraweeView simpleDraweeView){
