package com.zkjinshi.superservice.pad.blueTooth;
...
import com.zkjinshi.superservice.pad.vo.BeaconPushVo;
import com.zkjinshi.superservice.pad.vo.BeaconRssiVo;
...
public class BeaconsPushManager {
    ...
    private void lbsLocBeaconPush() {
        try {
            ...
            client.setMaxRetriesAndTimeout(1,1000*3);
