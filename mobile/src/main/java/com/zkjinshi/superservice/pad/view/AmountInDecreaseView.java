...
public class AmountInDecreaseView extends LinearLayout implements OnClickListener {
    ...
    private RelativeLayout mDescrease;
    ...
    public AmountInDecreaseView(Context context, AttributeSet attrs, int defStyle) {
        ...
        mContext = context;
        mDescrease = (RelativeLayout) findViewById(R.id.decrease);
        mIncrease  = (RelativeLayout) findViewById(R.id.increase);
    ...
    public int getNumber() {
        return Integer.parseInt(mNumberEditText.getText().toString());
    }
    ...
    private void hideInputKeyboard() {
        ...
        imm.hideSoftInputFromWindow(mNumberEditText.getWindowToken(), InputMethodManager.HIDE_NOT_ALWAYS);
    }
}
