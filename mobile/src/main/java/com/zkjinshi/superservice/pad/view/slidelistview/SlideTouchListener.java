package com.zkjinshi.superservice.pad.view.slidelistview;
...
import com.zkjinshi.superservice.pad.view.slidelistview.SlideListView.SlideAction;
import com.zkjinshi.superservice.pad.view.slidelistview.SlideListView.SlideMode;
import com.zkjinshi.superservice.pad.view.slidelistview.wrap.FrontViewWrapLayout;
import com.zkjinshi.superservice.pad.view.slidelistview.wrap.SlideItemWrapLayout;
...
public class SlideTouchListener implements OnTouchListener {
	...
	private class SlideItem {
		...
		public SlideItem(int pos) {
			position = pos;
			View view = mSlideListView.getChildAt(position - mSlideListView.getFirstVisiblePosition());
			child = (SlideItemWrapLayout) view.findViewById(R.id.slide_id_SlideItemWrapLayout);
			if (child == null) {
