...
import com.zkjinshi.superservice.pad.response.BasePavoResponse;
import com.zkjinshi.superservice.pad.utils.AsyncHttpClientUtil;
import com.zkjinshi.superservice.pad.utils.Base64Decoder;
...
public class SSOManager {
    ...
    public void requestRefreshToken(final Context context,final SSOCallBack ssoCallBack){
        try{
            ...
            client.setTimeout( com.zkjinshi.superservice.pad.utils.Constants.OVERTIMEOUT);
